...
%=================================================================
\documentclass[heritage,article,submit,pdftex,moreauthors]{Definitions/mdpi} 
...
% Units
\input{Aux_Files/Units}
\usepackage{subcaption}
\usepackage{textgreek}
\usepackage[table]{xcolor}

%% SET TABLE CELL COLOR
\newcommand{\SetCell}[1]{\cellcolor{#1}}
...
\newcommand{\temp}{\textit{T\textsubscript{a}}}
\newcommand{\rh}{\textit{RH}}
\newcommand{\rmse}{\textit{RMSE}}
\newcommand{\varfi}{\textit{F\textsubscript{i}}}
\newcommand{\varqv}{\textit{Q\textsubscript{v}}}
\newcommand{\vardetercoef}{\textit{R\textsuperscript{2}}}
\newcommand{\ic}{\textit{IC}}
\newcommand{\ach}{\textit{ACH}}
...
\newcommand{\orcidauthorB}{0000-0003-1312-8137} % Add \orcidB{} behind the author's name
\newcommand{\orcidauthorC}{0000-0001-6947-4579} % Add \orcidB{} behind the author's name
\newcommand{\orcidauthorD}{0000-0002-7015-6989} % Add \orcidB{} behind the author's name
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% REMAINING
%\input{Aux_Files/Text_Template_Aux}
...
\funding{The present work was funded by the Rectory of the University of Coimbra (UC) under the framework of the project ``BJUC-AHT - Monitorização e análise do ambiente interior na Biblioteca Joanina da Universidade de Coimbra'', and the doctoral Grant SFRH/BD/151356/2021 (\url{https://doi.org/10.54499/SFRH/BD/151356/2021}) financed by the Portuguese Foundation for Science and Technology (FCT), and with funds from the ``European Social Fund'' (FSE) and ``Programa Por Centro'' part of the Government Funds, under MIT Portugal Program.}
...
\acknowledgments{The work was also developed under the framework of the project ``Climate change-based building design guidelines'' (\url{https://doi.org/10.54499/PTDC/EME-REN/3460/2021}).}
...
\noindent 
\begin{tabular}{@{}ll}
\textit{TEMP} & Air temperature, \temperature\\
\textit{RH} & Air relative humidity, \percentage
\end{tabular}
}
